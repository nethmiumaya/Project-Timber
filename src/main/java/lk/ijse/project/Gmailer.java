...
public class Gmailer {
    private static final String EMAIL = "gunasekaranethmi0@gmail.com";
    ...
    private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory)
            throws IOException {
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory, new InputStreamReader(Gmailer.class.getResourceAsStream("/api/client_secret_901527427592-nh8cbcpv08loe0cd5agdoov6a7oq56lt.apps.googleusercontent.com.json")));
